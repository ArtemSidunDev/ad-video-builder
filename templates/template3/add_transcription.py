...
def create_caption(
    ...
    for word_info in xy_textclips_positions:
        ...
        if textJSON['start'] >= 0  and textJSON['end'] <= 4.1:
            y_offset = 0
        elif textJSON['start'] >= 4 and textJSON['end'] <= 11.6:
            y_offset = -250
        elif textJSON['start'] >= 11 and textJSON['end'] <= 20.9:
            y_offset = -250
        elif textJSON['start'] >= 22:
            y_offset = -250
...
frame_size = (video_dest_width, video_dest_width)
