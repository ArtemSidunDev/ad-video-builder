...
FONT = "./templates/template4/input/ProximaNova-Black.ttf"
FONT_SIZE = 160
FONT_COLOR = "#FFFFFF"
...
camera_audio = AudioFileClip("./templates/template4/input/camera.mp3").subclip(0.4, 0.8).fx(afx.audio_normalize).fx(afx.volumex, 0.5)
transition_audio = AudioFileClip("./templates/template4/input/transition.wav").subclip(0, 0.4).fx(afx.audio_normalize).fx(afx.volumex, 0.3)
