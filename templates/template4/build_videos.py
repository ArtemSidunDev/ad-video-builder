...
command = "ffmpeg-concat -T ./templates/template4/input/zoomin_transition.json -o " + output_file + f" {temp_folder}/04-1.mp4" + f" {temp_folder}/04-2.mp4"
print(command)
try:
...
command = "ffmpeg-concat -T ./templates/template4/input/zoomin_transition.json -o " + output_file +  f" {temp_folder}/07-1.mp4" + f" {temp_folder}/07-2.mp4"
...
command = ['ffmpeg-concat', '-T', "./templates/template4/input/transition.json",
